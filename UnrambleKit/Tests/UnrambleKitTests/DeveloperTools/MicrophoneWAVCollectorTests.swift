...
//
// Enable for one test process with UNRAMBLE_TEST_SAMPLE_COLLECTION=1. Set
// UNRAMBLE_SAMPLE_DIR to an existing output directory. Optionally set
// UNRAMBLE_SAMPLE_DURATION to a positive number of seconds; capture defaults
// to 10 seconds.
...
struct MicrophoneWAVCollectorTests {
    ...
    func privateFilePermissions() throws {
        let output = FileManager.default.temporaryDirectory.appendingPathComponent(
            "unramble-private-wav-\(UUID().uuidString)")
