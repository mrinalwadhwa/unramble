...
CI_SKIP_REGEX='(AudioPipelineTests|CGEventTapHotkeyProviderTests|CoreAudioDeviceProviderTests|KeychainServiceTests|LocalModelIntegrationTests|MainThreadDelayTests|NemotronStreamingTests|OpenAIBatchProviderLiveTests|OpenAIChatClientLiveTests|OpenAIRealtimeLiveTests|OpenAIStreamingBenchmarkTests|PermissionProviderTests|PipelineTimeoutTests|PolishScenarioRegexTests|PolishScenarioDeterministicTests|PolishScenarioCloudTests|PolishScenarioDumpCloud|ServiceConfigTests|SoundFeedbackPathTests)'
CI_FLAG_PATHS=(
